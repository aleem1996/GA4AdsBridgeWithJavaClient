 ...
 */
@Entity
@Table(name = "CampaignAttribution")
@DynamicInsert
@DynamicUpdate
public class CampaignAttribution implements Serializable {
	...
	private Integer purchasesGreaterThan28DayClick = 0;
	...
	private Double revenueGreaterThan28DayClick = 0.0;
	...
	public Integer getPurchasesGreaterThan28DayClick() {
		return purchasesGreaterThan28DayClick;
	}

	public void setPurchasesGreaterThan28DayClick(Integer purchasesGreaterThan28DayClick) {
		if(Util.isNotNull(purchasesGreaterThan28DayClick)) {
			this.purchasesGreaterThan28DayClick = purchasesGreaterThan28DayClick;
		}
	}

	public Double getRevenueGreaterThan28DayClick() {
		return revenueGreaterThan28DayClick;
	}

	public void setRevenueGreaterThan28DayClick(Double revenueGreaterThan28DayClick) {
		if (Util.isNotNull(revenueGreaterThan28DayClick)) {
			this.revenueGreaterThan28DayClick = revenueGreaterThan28DayClick;
		}
	}
